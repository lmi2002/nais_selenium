...
class ErcCompanyLocator:
    ...
    operation_category_name = (
        By.XPATH, '//li/span[text()="{operation_company_category}"]'.format(
            operation_company_category=setting_erc_data_info.company["operation_company_category"]))
    ...
    operation_company_locality = (By.XPATH, '//li//span[text()="{operation_company_locality}"]'.format(
        operation_company_locality=setting_erc_data_info.company["operation_company_locality"]))
    operation_company_region = (By.XPATH, '//li/span[text()="{operation_company_region}"]'.format(
        operation_company_region=setting_erc_data_info.company["operation_company_region"]))
    ...
    operation_company_address_address = (By.XPATH, '//li//span[text()="{operation_company_address}"]'.format(
        operation_company_address=setting_erc_data_info.company["operation_company_address"]))
    ...
    operation_company_subord_list = (By.XPATH, '//li/span[contains(text(), "{operation_company_subord}")]'.format(
        operation_company_subord=setting_erc_data_info.company["operation_company_subord"]))
