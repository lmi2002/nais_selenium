...
class TestOnlineMinjust(OnlineMinjustAuthMethod):
    ...
    def test_search_onm(self, start_module_obu):
        browser = start_module_obu
        pattern_file = 'onm.pdf'
        files = OnlineMinjustMainMethod().get_list_download_files()
        OnlineMinjustMainMethod().pass_to_page_service(browser)
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_address(self, start_module_obu):
        browser = start_module_obu
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_cad_num(self, start_module_obu):
        browser = start_module_obu
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_persone_code(self, start_module_obu):
        browser = start_module_obu
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_persone_name(self, start_module_obu):
        browser = start_module_obu
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_comp_code(self, start_module_obu):
        browser = start_module_obu
    ...
    @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_search_comp_name(self, start_module_obu):
        browser = start_module_obu
    ...
    # @pytest.mark.skip
    @pytest.mark.online_minjust
    def test_zaborona(self, start_module_obu):
        ...
        AuthMethod().login1(browser, data_gov_reg.get('username'), data_gov_reg.get('passw'),
